...
public class Entity extends BaseConcept implements INamedConcept {
  public static final String concept = "de.nerche.mps.typesystem.structure.Entity";
  ...
  public static Entity newInstance(SModel sm, boolean init) {
    return (Entity)SModelUtil_new.instantiateConceptDeclaration("de.nerche.mps.typesystem.structure.Entity", sm, GlobalScope.getInstance(), init).getAdapter();
  }
