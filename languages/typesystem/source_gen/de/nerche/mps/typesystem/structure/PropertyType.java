...
public class PropertyType extends BaseConcept {
  public static final String concept = "de.nerche.mps.typesystem.structure.PropertyType";
  ...
  public static PropertyType newInstance(SModel sm, boolean init) {
    return (PropertyType)SModelUtil_new.instantiateConceptDeclaration("de.nerche.mps.typesystem.structure.PropertyType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
