...
public class Entity extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.samples.typesystem.structure.Entity";
  ...
  public static Entity newInstance(SModel sm, boolean init) {
    return (Entity)SModelUtil_new.instantiateConceptDeclaration("mps.samples.typesystem.structure.Entity", sm, GlobalScope.getInstance(), init).getAdapter();
  }
