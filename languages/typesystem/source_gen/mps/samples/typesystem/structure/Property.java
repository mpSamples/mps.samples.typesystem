...
public class Property extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.samples.typesystem.structure.Property";
  ...
  public static Property newInstance(SModel sm, boolean init) {
    return (Property)SModelUtil_new.instantiateConceptDeclaration("mps.samples.typesystem.structure.Property", sm, GlobalScope.getInstance(), init).getAdapter();
  }
