...
public class EntityType extends PropertyType {
  public static final String concept = "mps.typesystem.structure.EntityType";
  ...
  public static EntityType newInstance(SModel sm, boolean init) {
    return (EntityType)SModelUtil_new.instantiateConceptDeclaration("mps.typesystem.structure.EntityType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
