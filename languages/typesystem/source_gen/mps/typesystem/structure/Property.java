...
public class Property extends BaseConcept implements INamedConcept {
  public static final String concept = "mps.typesystem.structure.Property";
  ...
  public static Property newInstance(SModel sm, boolean init) {
    return (Property)SModelUtil_new.instantiateConceptDeclaration("mps.typesystem.structure.Property", sm, GlobalScope.getInstance(), init).getAdapter();
  }
